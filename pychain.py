...
#input_data = st.text_input("Block Data") commented this out
...
if st.button("Add Block"):
    ...
    # and `amount` values
    #new_block = Block(record=Record,creator_id=sender,prev_hash=prev_block_hash)
    new_block = Block(record=Record(sender=sender_data,receiver=receiver_data,amount=amount_data),creator_id=42,prev_hash=prev_block_hash)
